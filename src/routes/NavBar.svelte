<script>
	...
	const handleClick = (index) => {
		// Dispatch event or use a callback if needed
		// For now, just scroll to the slide
...
<nav class="fixed top-0 left-0 z-50 flex h-full w-20 flex-col items-center bg-transparent py-8">
	<div class="flex h-full w-full flex-col items-center justify-center">
		{#each slides as slide, index}
			<button
				class="group relative flex flex-col items-center focus:outline-none"
